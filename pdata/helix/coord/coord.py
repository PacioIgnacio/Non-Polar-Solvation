...
for i in range(1, 10):
    ...
    pdb_file = "/home/ignacio/DonElias/NPT.Lambda/0" + \
        str(i) + "ALA/extended/coord/pdb2g96_peptide.arg"
    gch_file = "/home/ignacio/DonElias/NPT.Lambda/0" + \
        str(i) + "ALA/extended/coord/gch_peptide.arg"
    frameout_file = "/home/ignacio/DonElias/NPT.Lambda/0" + \
        str(i) + "ALA/extended/coord/frameout_peptide.arg"
    lib_file = "/home/ignacio/DonElias/NPT.Lambda/0" + \
        str(i) + "ALA/extended/coord/pdb2g96.lib"
...
sh_file = "/home/ignacio/DonElias/NPT.Lambda/pdata/helix/coord/coord.sh"
