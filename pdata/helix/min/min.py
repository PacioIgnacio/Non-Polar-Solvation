...
for i in range(1, 10):
    ...
    run_file = "/home/ignacio/DonElias/NPT.Lambda/0" + \
        str(i) + "ALA/helix/min/em_peptide.run"
    imd_file = "/home/ignacio/DonElias/NPT.Lambda/0" + \
        str(i) + "ALA/helix/min/em_peptide.imd"
    frameout_file = "/home/ignacio/DonElias/NPT.Lambda/0" + \
        str(i) + "ALA/helix/min/frameout_peptide.arg"
...
sh_file = "/home/ignacio/DonElias/NPT.Lambda/pdata/min/min.sh"
